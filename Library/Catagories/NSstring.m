...
@implementation NSString (catagories)
...
-(NSString *)URLENCODEING{
    ...
    [tempStr stringByReplacingPercentEscapesUsingEncoding:NSStringEncodingConversionAllowLossy];
...
-(NSString *)stringByConvertingHTMLToPlainText {
	...
	NSCharacterSet *newLineAndWhitespaceCharacters = [NSCharacterSet characterSetWithCharactersInString:[NSString stringWithFormat:@" \t\n\r%C%C%C%C", (unichar)0x0085, (unichar)(unichar)0x000C, (unichar)0x2028,(unichar) 0x2029]];
