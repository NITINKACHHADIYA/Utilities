...
- (void)layoutSubviews {
    ...
    /*if ([[[UIDevice currentDevice] systemVersion] floatValue]>=7.0) {
        ...
        labelSize = [label.text sizeWithAttributes:dictionary];
        ...
        NSDictionary *dictionary1 = [[NSDictionary alloc] initWithObjectsAndKeys:
                                     detailsLabel.font, NSFontAttributeName,
                                     paragraphStyle,NSParagraphStyleAttributeName,nil];
        detailsLabelSize = [detailsLabel.text sizeWithAttributes:dictionary1];
